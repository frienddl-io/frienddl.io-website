...
(function ($) {
	...
	// 			if(thisTarget === '/resume') {
	// 				// console.log('Waiting for target');
	// 				var checkIfDropboxExists = setInterval(
	// 					() => {
	// 						let target = document.getElementById('dropbox');
	// 						if (target !== null) {
	// 							// console.log('Target exists');
	// 							let options = {
	// 								// Shared link to Dropbox file
	// 								link: 'https://www.dropbox.com/s/dr59ip9y5r2x0tr/Blake%20Gearin%20R%C3%A9sum%C3%A9.pdf?dl=0',
	// 								file: {
	...
	// 								}
	// 							}
	// 							Dropbox.embed(options, target);

	// 							// console.log('Finished processing target');
	// 							clearInterval(checkIfDropboxExists);
	// 						} else {
	...
	// 	let betterNavTarget = navTarget.replace('.html', '');
	// 	// console.log('Adding active-link to a[href="' + betterNavTarget + '"]')
	// 	$('a[href="' + betterNavTarget + '"]').addClass('active-link');
